...
class dMap:
   ...
   def makeMap(self,xsize,ysize,fail,b1,mrooms):
       ...
       failed=0
       while failed<fail or len(self.roomList) < 5: #The lower the value that failed< , the smaller the dungeon
...
# ----------------------------------------------------------------------------
startx=25   # map width
starty=25   # map height
themap= dMap()
themap.makeMap(startx,starty,250,10,6) 
